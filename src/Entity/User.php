 ...
 * * @UniqueEntity(
 *  fields={"email"},
 *  message="Une autre utilisateur s'est deja inscrit avec cette adresse email, merci de la modifier")
 */
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=5, minMessage="L'intro doit avoir au moins  5 caractères")
     */
    ...
    // Methodes implémentées de l'interface UserInterface :
    //1.
