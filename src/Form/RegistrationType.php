...
class RegistrationType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('picture', UrlType::class, $this->getConfiguration("Photo de profil","Photo de votre Avatar.."))
            ...
            ->add('description', TextareaType::class, $this->getConfiguration("Decription","Votre Decription"))
        ;
    }
